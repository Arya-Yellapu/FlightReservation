...
<td><a href="<c:url value='http://localhost:8080/users/getSeatsAvailable?flightno=${list[status.index].flightno}&seats=${count}&userName=${username}&passWord=${password}&trip=${Trip}'/>">Select flight</a></td>
</tr>
</c:forEach>
<br>
